...
if (isset($_POST['reg_user'])) {
  ...
  $user_check_query = "SELECT * FROM emp WHERE username='$username' OR email='$email' LIMIT 1";
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO emp (username, email, password, Name, Address, GENDER, PhoneNumber, AadharNumber, PANNumber, AccountNumber) 
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
	...
	$records = mysqli_query($db,"select * from emp where username='$username'");
